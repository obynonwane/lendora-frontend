...
function Page() {
  ...
  useEffect(() => {
    ...
    // const myID = userData?.detail.user.id;
    // "ccff97be-ed65-4562-a640-022e85615637"
    // const defaultReceiver = "66505609-9039-49fb-8e35-65db84b806c1";
    // const defaultReceiver = "6b3d6361-4f8a-464d-9d93-99d8d866b9d9";
  ...
  // chat page
  return (
    <main className="max-w-7xl mx-auto lg:p-3 lg:h-[80vh] h-[79vh] ">
      <section className="flex border h-full rounded">
        <aside
          className={`lg:w-[350px] border-r bg-white lg:h-full h-[79vh] transition-transform duration-[10s] ease-in-out max-h-full overflow-y-auto lg:relative fixed  w-full   ${
            isShowChatList
              ? "lg:left-auto left-0"
        ...
        <div className="w-full white flex flex-col">
          <div className="header border-b p-3 bg-white flex">
            <span
          ...
          <div className="chat_container h-full flex-1 overflow-y-auto p-3 flex flex-col gap-8">
            {!chatId ? (
