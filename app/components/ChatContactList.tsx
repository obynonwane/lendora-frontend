...
import { ChatListUser_TYPE, ChatHistoryItem } from "@/app/types";
...
function ChatContactList({
  ...
  chatListData: { data: ChatListUser_TYPE[] };
  isFetchingChatList: boolean;
  isChatListEError: boolean;
    ...
    <>
      ...
      <aside
        className={`lg:w-[350px] z-20 border-r flex flex-col bg-white h-full transition-transform duration-[10s] ease-in-out max-h-full overflow-y-auto lg:relative fixed  w-full   ${
          isShowChatList ? "lg:left-auto left-0" : " lg:-left-0 -left-[100vw] "
        } `}
      >
