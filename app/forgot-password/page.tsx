    ...
    <main className="flex justify-center md:h-screen items-center p-5 md:mt-0 mt-8 overflow-y-auto">
      {step === "forgot-password" && (
        ...
        >
          ...
          <button
            type="submit"
            className={`flex w-full justify-center rounded py-4 bg-lendora-500  text-white hover:bg-lendora-600 hover:shadow-lg shadow mt-5 font-semibold ${
          ...
          <Link
            href="/login"
            className={` text-center block mt-4 text-sm text-lendora-500  underline  `}
          >
            Back to Login
          </Link>
        </form>
      ...
      {step === "password-reset-email-sent" && (
        <div className="w-full md:w-[400px] pt-10 text-center">
          <p className="text-center  mb-2 ">
            <GiEnvelope className="text-6xl text-lendora-500 mx-auto" />
          </p>
          ...
          <Link
            href="/login"
            className={`flex w-full justify-center rounded bg-lendora-500  text-white hover:bg-lendora-600 hover:shadow-lg shadow mt-5 py-4 `}
          >
            Back to Login
          </Link>
        </div>
